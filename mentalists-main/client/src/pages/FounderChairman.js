  ...
  return (
    <div className="min-h-screen bg-gray-50 pt-20 sm:pt-28 px-2 sm:px-4 lg:px-8">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-4 sm:p-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-900 mb-4 sm:mb-6 text-center">Chairman & Managing Trustee</h1>
        <p className="text-gray-700 text-base sm:text-lg mb-4 sm:mb-6 text-center">Meet our visionary leader and founder.</p>
