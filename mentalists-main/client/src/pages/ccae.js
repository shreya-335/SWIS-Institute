...
const MissionSection = ({ isVisible }) => {
  ...
  return (
    <section
      id="mission"
      className="py-16 sm:py-20 bg-gradient-to-br from-[#FCFDFF] via-[#d2d5e0]/30 to-[#8e9fc5]/20 relative overflow-hidden"
    >
          ...
          {missionCards.map((item, index) => (
            ...
            >
              <div className="text-[#023080] mb-6 flex justify-center">
                <div className="bg-gradient-to-br from-[#8e9fc5]/20 to-[#d2d5e0]/30 p-4 rounded-2xl">{item.icon}</div>
              </div>
              <h3 className="text-xl sm:text-2xl font-semibold text-[#023080] mb-4 text-center">{item.title}</h3>
...
const MetricsSection = ({ isVisible, countAnimated }) => {
  const impactMetrics = [
    ...
    },
    {
      ...
      image:
        "https://images.unsplash.com/photo-1594736797933-d0d4ffd9d6ad?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80",
      size: "large",
    },
    {
      number: 16,
    ...
    <section id="cta" className="py-16 sm:py-20 bg-gradient-to-r from-[#023080] to-[#04307b] text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
        <div className={isVisible ? "animate-fadeInUp" : "opacity-0"}>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-light mb-8">Join Our Fellowship</h2>
