...
const MissionSection = ({ isVisible }) => {
  const missionCards = [
    {
      ...
      content:
        "At SWIS, we believe that democracy thrives when citizens are engaged and informed. The Centre for Civil Administration & Engagement is our initiative to build civic consciousness through fellowships, structured volunteering, and real-world exposure to public systems.",
    ...
    },
    {
      ...
      content:
        "By placing young citizens in the heart of governance and community action, CCAE nurtures a new culture of ethical public engagement. Our goal is to create a generation that doesn't just demand change—but knows how to deliver it.",
    ...
    },
    {
      ...
      content:
        "Through mentorship, training, and field experiences with local government bodies and civil society partners, CCAE transforms idealism into public leadership. Every program we run is an investment in participatory democracy and responsive governance.",
  ...
  return (
    <section
      id="mission"
      className="py-12 sm:py-16 md:py-20 bg-gradient-to-br from-[#FCFDFF] via-[#d2d5e0]/30 to-[#8e9fc5]/20 relative overflow-hidden"
    >
          ...
          {missionCards.map((item, index) => (
            ...
            >
              <div className="text-[#023080] mb-4 sm:mb-6 flex justify-center">
                <div className="bg-gradient-to-br from-[#8e9fc5]/20 to-[#d2d5e0]/30 p-3 sm:p-4 rounded-xl sm:rounded-2xl">{item.icon}</div>
              </div>
              <h3 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#023080] mb-2 sm:mb-4 text-center">{item.title}</h3>
              <p className="text-[#04307b] leading-relaxed text-center text-sm sm:text-base">{item.content}</p>
            </div>
          ))}
        </div>
        ...
        <div className={`text-center ${isVisible ? "animate-fadeInUp stagger-4" : "opacity-0"}`}>
          <div className="bg-gradient-to-r from-[#023080] to-[#04307b] text-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 shadow-2xl">
            ...
            <p className="text-base sm:text-lg md:text-xl text-[#d2d5e0] mb-4 sm:mb-6 max-w-3xl mx-auto">
              Every citizen has the power to shape their community's future. Through CCAE, we're building the bridge
              between civic awareness and meaningful action.
            </p>
            <a
              href="/JoinUs"
  ...
  const objectives = [
    {
      ...
      title: "Awareness",
      description:
        "To raise awareness about the development sector and foster understanding of civic responsibilities.",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className={`text-center mb-6 sm:mb-8 md:mb-12 ${isVisible ? "animate-fadeInUp" : "opacity-0"}`}>
          ...
          <p className="text-base sm:text-lg md:text-xl text-[#04307b] max-w-3xl mx-auto">
            Comprehensive approach to building civic leadership and fostering democratic participation through
            structured programs.
          </p>
        </div>
...
const MetricsSection = ({ isVisible, countAnimated }) => {
  const impactMetrics = [
    ...
    { number: 10, suffix: "+", label: "Mentors", icon: <Target className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 100, suffix: "+", label: "Nonprofits Supported", icon: <Award className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa3, hasImage: true },
    { number: 5, suffix: "+", label: "Collaborators", icon: <BookOpen className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 2000, suffix: "+", label: "Households Served", icon: <Users className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa5, hasImage: true },
    { number: 500, suffix: "+", label: "Youth Empowered", icon: <TrendingUp className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 10, suffix: "", label: "Grand Challenges", icon: <Lightbulb className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa7, hasImage: true },
    { number: 20, suffix: "+", label: "Webinars held", icon: <Award className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
  ...
  return (
    <section
      id="metrics"
      className="py-10 sm:py-12 md:py-16 bg-gradient-to-br from-[#FCFDFF] via-[#d2d5e0] to-[#8e9fc5] relative overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className={`text-center mb-4 sm:mb-6 md:mb-8 ${isVisible ? "animate-fadeInUp" : "opacity-0"}`}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light mb-2 sm:mb-4 text-[#023080] italic">
            Our Work in Numbers
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-[#04307b] max-w-3xl mx-auto">
    ...
    <section id="cta" className="py-12 sm:py-16 md:py-20 bg-gradient-to-r from-[#023080] to-[#04307b] text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
        <div className={isVisible ? "animate-fadeInUp" : "opacity-0"}>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light mb-4 sm:mb-6">Join Our Fellowship</h2>
          <p className="text-base sm:text-lg md:text-xl text-[#d2d5e0] mb-4 sm:mb-6 md:mb-8 leading-relaxed">
            Be part of building a stronger democracy through civic engagement and public service. Help us create the
            next generation of ethical public leaders.
          </p>
