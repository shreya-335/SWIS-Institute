          ...
          >
            ...
            <div className="mt-8 p-4 bg-blue-800/50 rounded-lg inline-block">
              <p className="text-sm text-blue-200">
                The term "members" refers to all individuals associated with the organization, including full-time,
                part-time, and contractual staff, volunteers, fellows, interns, board members, and alumni.
              </p>
            </div>
          </motion.div>
        </div>
