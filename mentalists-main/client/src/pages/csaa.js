      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <div className={`text-center ${isVisible ? 'animate-fadeInUp stagger-4' : 'opacity-0'}`}>
          <div className="bg-gradient-to-r from-[#023080] to-[#04307b] text-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-12 shadow-2xl">
            ...
            <a href="/JoinUs" className="bg-white text-[#023080] px-6 sm:px-8 py-2 sm:py-3 md:py-4 rounded-full hover:bg-[#FCFDFF] transition-all duration-300 transform hover:scale-105 text-base sm:text-lg">
              Start Your Journey
            </a>
          </div>
        </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
          {objectives.map((objective, index) => (
            ...
            >
              <div className={`inline-flex items-center justify-center w-12 sm:w-16 h-12 sm:h-16 rounded-xl sm:rounded-2xl bg-gradient-to-r ${objective.color} text-white mb-4 sm:mb-6`}>
                {objective.icon}
              </div>
...
const MetricsSection = ({ isVisible, countAnimated }) => {
  const impactMetrics = [
    ...
    { number: 25, suffix: "+", label: "Schools", icon: <Target className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 100, suffix: "+", label: "Nonprofits Supported", icon: <Award className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa3, hasImage: true },
    { number: 10, suffix: "+", label: "Universities", icon: <BookOpen className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 2000, suffix: "+", label: "Households Served", icon: <Users className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa5, hasImage: true },
    { number: 3000, suffix: "+", label: "Students", icon: <TrendingUp className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
    { number: 10, suffix: "", label: "Grand Challenges", icon: <Lightbulb className="w-6 sm:w-8 h-6 sm:h-8" />, image: csaa7, hasImage: true },
    { number: 10, suffix: "", label: "Sustainable Projects", icon: <Award className="w-5 sm:w-7 h-5 sm:h-7" />, hasImage: false },
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-12 text-center">
        <div className={isVisible ? 'animate-fadeInUp' : 'opacity-0'}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a href="/JoinUs" className="border border-white text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full hover:bg-white hover:text-black transition-all duration-300 flex items-center gap-2 justify-center text-base sm:text-lg">
              Apply Now <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5" />
            </a>
          </div>
        </div>
